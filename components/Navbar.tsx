...
>>>>>>> 423bef44cda90b5481ce563473b63bdc254f82f1
          : 'bg-transparent'
        }`}
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between py-4">
        ...
        >
          ...
          <div className="relative h-10 w-32 flex items-center justify-center">
            <Image
<<<<<<< HEAD
              src={appliedScrolled ? "/cis-logo.webp" : "/CISLogoWhite.png"}
=======
              src="/cis-logo.png"
>>>>>>> 423bef44cda90b5481ce563473b63bdc254f82f1
              alt="IEEE CIS"
...
<<<<<<< HEAD
            className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 shadow-sm hover:shadow-md ${
              appliedScrolled
=======
...
<<<<<<< HEAD
          ...
          className={`md:hidden p-2 rounded-lg transition-colors duration-200 ${
            appliedScrolled ? 'text-ieee-text-dark hover:bg-ieee-sky' : 'text-white hover:bg-white/10'
          }`}
=======
